...
(function () {
	...
	$(function () {
		...
		var d3Charts = [];
		var splineChartObjectData = [1.5, 2.4, 3.3, 3.9, 3.8, 3.6, 3.55, 3.9, 5.4, 6.1],
			splineChartObject = {
				bindto: '#spline-chart',
				legend: {
					show: false
				...
				data: {
					x: 'x',
					columns: [
						['x', '2007-01-01', '2008-01-01', '2009-01-01', '2010-04-01', '2011-04-01', '2012-01-01', '2013-01-01', '2014-01-01', '2017-01-01','2018-01-01','2020-01-01'],
